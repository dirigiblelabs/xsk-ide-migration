...
let editors = [];
migrationLaunchView.controller('ChangesViewController', ['$scope', '$http', '$messageHub', '$timeout', function ($scope, $http, $messageHub, $timeout) {
    ...
    $messageHub.on('migration.changes', function (msg) {
